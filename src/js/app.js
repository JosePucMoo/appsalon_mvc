...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true) {
    ...
    // Previene que se genere más de una alerta al mismo tiempo
...
function mostrarResumen() {
    ...
    if( Object.values(cita).includes('') || cita.servicios.length === 0 ) {
        mostrarAlerta('Faltan datos de servicios, fecha u hora',
            'error', 
            '.contenido-resumen',
            false);
        return;
